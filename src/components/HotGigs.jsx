...
import { BASE_URL, HOT_GIGS } from '../service/service'
...
console.log("hot gigs",hotgigs);
  return (
    <>
       <h1 className=' w-full mt-4 text-center text-2xl font-extrabold'> <u>Hot Gigs</u></h1>
    <div className=" w-full flex flex-row justify-around" >
    {
        hotgigs.map((item) => {
            ...
            <div className="flex flex-col items-center pb-10">
                ...
                <h5 className="mb-1 text-xl font-medium text-gray-900 dark:text-white">Name: {item.dtls.hshtg[0].tag}</h5>
                <span className="text-sm text-gray-500 dark:text-gray-400">  id:{item.dtls.hshtg[0].Id}</span>
                <span className="text-sm text-gray-500 dark:text-gray-400">  city:{item.dtls.loc.city}</span>
